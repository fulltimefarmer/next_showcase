// ============================================================================
// 【Next.js 知识点】Client Component — 只读列表 + 手动刷新
// ============================================================================
// 1. 审计日志是只读数据，只有"刷新"按钮触发重新获取
// 2. loading 状态管理按钮的禁用与图标旋转动画
// 3. actionMap 把 action 字符串映射为颜色徽章（create/update/delete/approve/reject）
// 4. JSONB details 字段用 JSON.stringify 展示
// ============================================================================
