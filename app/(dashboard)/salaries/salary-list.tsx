// ============================================================================
// 【Next.js 知识点】Client Component — 实时计算预览 + Payslip 弹窗
// ============================================================================
// 1. form.watch("baseSalary") 实时监听输入，前端同步计算"实发金额"预览
//    - 与服务端 actions.ts 的 actualPayment 公式一致，但服务端入库为准
// 2. 状态机 UI: draft 状态显示 [编辑][发放] 按钮，paid 状态不可编辑
// 3. Payslip 详情弹窗: 点击员工名弹出工资条（只读展示）
// 4. 客户端通过 useState 管理数据，操作后调用 getSalaries() 刷新
// ============================================================================
