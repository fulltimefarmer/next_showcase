// ============================================================================
// 【Next.js 知识点】Client Component — 资产状态跟踪 + 跨模块下拉框
// ============================================================================
// 1. "use client" 客户端组件，管理表单/弹窗/列表刷新
// 2. 状态流转: status 字段通过 select 选择（available/in_use/maintenance）
// 3. 跨模块数据: initialEmps 来自 employees 模块，用于"使用人"下拉框
// 4. 客户端通过 useState 管理数据，调用 Server Action 后重新 getAssets() 刷新
// ============================================================================
